...
import me.anouar.filedialog.utils.KeyboardUtils;
...
public abstract class FileDialog extends DialogFragment implements FileListAdapter.OnFileSelectedListener {
    ...
    protected OnFileSelectedListener m_listener;
    ...
    public void set_listener( OnFileSelectedListener listener )
    {
        m_listener = listener;
    }
    ...
    protected void sendResult(File file) {
        ...
        */
        ...
        if(m_listener != null )
        {
            m_listener.onFileSelected( this , file );
        }
        ...
        protected void onPostExecute(File[] localFiles) {
            ...
            if (!isCancelled() && getActivity() != null) {
                ...
                if (mDirectory.getPath().equalsIgnoreCase(EXTERNAL_ROOT_PATH)) {
                    ...
                    navIcon = ResourcesCompat.getDrawable(getResources(), R.drawable.ic_back , null);
                }
